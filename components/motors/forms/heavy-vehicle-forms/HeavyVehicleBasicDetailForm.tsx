...
const HeavyVehicleBasicDetailForm = ({
  initalData,
  mode = "create",
  ...props
}: Props) => {
      ...
      <ScrollView contentContainerClassName="px-6 pt-6 relative bg-gray-100">
        <View className="gap-4">
          ...
          {/* <Controller
            ...
            render={({ field, formState }) => (
              <InputField
                errorMessage={formState.errors["weight"]?.message as string}
          ...
          <Controller
            ...
            render={({ field, formState }) => (
              <View className="gap-1.5">
                <Text className="text-lg font-bold">Has Warrany ?</Text>
                <View>
                  <RadioButton
                    isChecked={
...
export default HeavyVehicleBasicDetailForm;
