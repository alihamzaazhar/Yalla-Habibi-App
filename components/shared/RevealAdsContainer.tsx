...
const RevealAdsContainer_ = ({
  ...
  return (
    <>
      <Animated.View
        className={contentsContainerClassName}
        onLayout={(e) => {
      ...
      {adElement ? (
        adType === "fullscreen" ? (
          ...
          <Animated.View className={contentsContainerClassName}>
            {adElement}
          </Animated.View>
        )
      ) : null}
...
type Props = {
  contentsContainerClassName?: string;
  contentElementsWithAds: {
    contentElements: React.ReactNode[];
    adElement?: React.ReactElement;
    adType?: "fullscreen" | "card";
  }[];
};
const RevealAdsContainer = ({
  contentsContainerClassName,
  contentElementsWithAds,
}: Props) => {
  ...
  return (
    <View>
      {contentElementsWithAds.map(
        ({ contentElements, adType, adElement }, idx) => (
          <RevealAdsContainer_
...
export default RevealAdsContainer;
